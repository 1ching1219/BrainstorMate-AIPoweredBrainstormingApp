<<<<<<< HEAD:web_frontend/src/components/VideoRoom.js
...
// import { FiVideo, FiVideoOff, FiMic, FiMicOff, FiMessageSquare, FiX } from "react-icons/fi";
// import Chat from './Chat';
>>>>>>> 3cfa18ac4f2079b9c6c63d61616a270ca793a929:video_app/frontend/src/components/VideoRoom.js
...
<<<<<<< HEAD:web_frontend/src/components/VideoRoom.js
  useEffect(() => {
    ...
    socketRef.current = new WebSocket(getWebSocketUrl(roomId));
=======
//   useEffect(() => {
//     // Connect to the WebSocket
...
//       });
  ...
  useEffect(() => {
    if (videoEnabled && userVideo.current && streamRef.current) {
