...
import { getWebSocketUrl, getParticipants, getMessages, sendMessage } from '../services/api';
  ...
  const renderFeedbackItem = ({ item, index }) => (
    <View style={styles.feedbackItem}>
      <View style={styles.avatar}>
        <Image 
          source={AI_AVATARS[item.agent.toLowerCase()] || AI_AVATARS.designer}
          style={styles.avatarImage}
          onError={(e) => {
            // If image fails to load, show a fallback view
